  ...
  return (
    <div id="Expertise">
      <div className="container pt-10">
        ...
        <div className="flex flex-col  pt-10 gap-y-4 gap-x-2 sm:flex-row">
          <div className="flex flex-col  py-4 px-1 ml-4 items-center justify-start rounded-lg bg-neutral-50 shadow-xl ">
            ...
            <h1 className="text-headingColor pt-10 font-bold text:xl sm:text-md md:text-lg  lg:text-xl">
          ...
          <div className="flex flex-col py-4 px-1 ml-4 items-center justify-start rounded-lg bg-neutral-50 shadow-xl ">
            ...
            <h1 className="text-headingColor pt-10 font-bold text-xl">
              Web Development
            </h1>
            <p className="font-[500] pl-2 py-1 text-sm lg:text-[15px] leading-7 mt-2">
              {" "}
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consequuntur soluta, cum atque neque debitis consequatur illo
              ipsum{" "}
